...
$$
\mathbb{E}(Ant; Edad,Trat = 0) = b_0 + b_1 Edad + b_2 \cdot 0 + b_3Edad \cdot 0 = b_0 + b_1 Edad = 29.3 - 0.3 Edad
$$
Por otro lado para el grupo que recibe el medicamento tenemos que:
$$
\mathbb{E}(Ant; Edad,Trat = 1) = b_0 + b_1 Edad + b_2 \cdot 1 + b_3Edad \cdot 1 = 29.3 - 0.3 Edad - 2.3 + 0.2 \cdot Edad = 27 - 0.1 Edad
$$
...
Entonces para realizar esta prueba de hipótesis, podemos comparar las medias obtenidas anteriormente, para comparar si existe un cambio en la generación de anticuerpos con respecto a la edad, así nuestra prueba de hipótesis queda como:

$$
H_0: b_2 + b_3 = 0 \quad vs \quad H_1: b_2 + b_3 \neq 0
$$
...
- $b_3$: Es el coeficiente asociado a la interacción entre la edad y la administración del medicamento, es decir por cada año que aumenta la edad y se aplica el medicamento disminuye en 0.1 la generación de anticuerpos.
